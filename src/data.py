words = [
    ...
    ['algoritmo', 'Uma sequencia de instruções, um passoa a passo não ambíguo.'],
    ...
    ['padaria', 'Local onde se fáz uma grande variedade de maças para vender.'],
    ['cerveja', 'Bebida alcolica ou não, derivada do trigo, milho ou cevada.'],
    ...
    ['pimenta', 'Uma fruta muito comum em todo o mundo usada para temperar alimento, muito famosa por ter veriações picantes.'],
    ...
    ['janela', 'Parte de um edifício usada para ventiar ou permitir que a luz natural entre.'],
    ...
    ['sapo', 'Anumal que vive em áeas alagadas, e se beijar "vira prícipe".'],
    ...
    ['tomate', 'Fruto vermelho muito utilizado na culiária, de saladas a condimentos e sucos.'],
    ...
    ['carimbo',
        'Geramlente feito de madeira com uma borracha na ponta, uma marcação (impressão) de texto rápida.'],
    ...
    ['zebra', 'Animal selvágem e listrado da família dos equinos.'],
    ...
    ['passaro', 'Aves que apresentam algumas características marcantes, como pé anisodáctilo.'],
