words = [
    ...
    ['programação', 'O processo de criação de software ou scripts para direcionar o comportamento de um computador.'],
    ['linguágem', 'Qualquer meio compreensível usado como ferramenta para se comunicar.'],
    ...
    ['algorítmo', 'Uma sequencia de instruções, um passo a passo não ambíguo.'],
    ['balisa', 'Para se preparar para enfrentar o transito enquanto apende a dirigir.'],
    ['água', 'Um dos elementos mais abundantes no planeta Terra e uma base para a vida.'],
    ...
    ['lampião', 'Espécie de lampada antiga alimentadas por liquidos inflamáveis, energia ou gases. muito comum até hoje.'],
    ...
    ['juíz', 'Aquele que aplica a lei de forma correta após a avaliação dos fatos.'],
    ...
    ['caminhão', 'Veículo de grande porte geralmente utilizado para levar cargas.'],
    ...
    ['raíz', 'Um órgão vegetal que apresenta como função principal a sustentação da planta e a absorção de água e sais minerais.'],
    ...
    ['salafrário', ' Indivíduo desonesto, desleal, sem escrúpulos, desprezível, reles, bisbórria, etc.'],
    ...
    ['calendário', 'sistema para contagem e agrupamento de dias que visa a atender principalmente às necessidades civis e religiosas de uma cultura.'],
    ['planilha',
    ...
    ['ônibus', 'Meio de transporte coletivo de grande porte sobe rodovías.'],
    ['carimbo',
    ...
    ['espírito', 'Porção imaterial ou imortal do ser humano; alma.'],
    ['costela', 'Ossos planos e curvos que constituem a maior parte da caixa torácica.'],
    ['barracão', 'Abrigo, telheiro ou casa provisória, geralmente de madeira para guarda de utensílios.'],
    ...
    ['parábola', 'Narrativa alegórica que transmite uma mensagem indireta, por meio de comparação ou analogia.'],
    ...
    ['preguiçoso', 'Aquele que é sempre desanimado, não trabalha ou estuda; vadio.'],
    ['último', 'Que chegou atrasado, que perdeu uma corrida.'],
]
